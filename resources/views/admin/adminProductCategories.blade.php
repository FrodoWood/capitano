...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10">
                ...
                <div class="container">
                    @foreach ($categories as $category)
                        <div class="row mb-2 p-1 py-2 border rounded">
                            <div class="col-lg-9">
                                <form action="{{ route('updateProductCategory', $category->id) }}" method="POST" id="create-form-{{$category->id}}">
                                    ...
                                    <div class="row justify-content-md-around">
                                        ...
                                        <div class="form-group col-md-1">
                                            ...
                                            <input type="text" id="category-id-{{ $category->id }}" value="{{ $category->id }}" class="form-control border-0 bg-" disabled>
                                        </div>
            ...
            <div class="col-lg-2 p-2 border rounded overflow-auto">
                <div class="container">
