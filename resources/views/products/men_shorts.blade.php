        ...
        <div class="container-fluid" style=" background-color: #fff; padding: 11px;">
            <div class="row">
                ...
                <script>
                    ...
                    <ul class="image_list text-center" style="list-style:none;">
                        <li style="margin-top:50px;" data-image="<?=url('/images/Men\'s shorts 1.png');?>"><img height="100" onClick="changepic(this);" src="<?=url('/images/Men\'s shorts 1.png');?>" alt=""></li>
                        <li style="margin-top:50px;" data-image="<?=url('/images/Men\'s shorts 2.png.png');?>"><img height="100" onClick="changepic(this);"  src="<?=url('/images/Men\'s shorts 2.png');?>" alt=""></li>
                        <li style="margin-top:50px;" data-image="<?=url('/images/Men\'s shorts 3.png.png');?>"><img height="100" onClick="changepic(this);"  src="<?=url('/images/Men\'s shorts 3.png');?>" alt=""></li>
                ...
                <div class="carousel-inner" style="height:560px">
                    ...
                    <img  style="height:560px" src="<?=url('/images/Men\'s shorts 1.png');?>" alt="">
                    </div>

                    <div class="item" id="Red">
                    <img  style="height:560px" src="<?=url('/images/Men\'s shorts 2.png');?>" alt="">
                    </div>
                    <div class="item" id="Blue">
                    <img  style="height:560px" src="<?=url('/images/Men\'s shorts 3.png');?>" alt="">
                    </div>
