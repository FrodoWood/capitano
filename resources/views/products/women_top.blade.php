            ...
            <div class="row">
                ...
                <script>
                    ...
                    <ul class="image_list" style="list-style:none;">
                        <li style="margin-top:50px;" data-image="<?=url('/images/Women\'s top 1.png');?>"><img height="150" onClick="changepic(this);" src="<?=url('/images/Women\'s top 1.png');?>" alt=""></li>
                        <li style="margin-top:50px;" data-image="<?=url('/images/Women\'s top 2.png.png');?>"><img height="150" onClick="changepic(this);"  src="<?=url('/images/Women\'s top 2.png');?>" alt=""></li>
                        <li style="margin-top:50px;" data-image="<?=url('/images/Women\'s top 3.png.png');?>"><img height="150" onClick="changepic(this);"  src="<?=url('/images/Women\'s top 3.png');?>" alt=""></li>
                ...
                <div class="carousel-inner" style="height:560px">
                    ...
                    <img  style="height:560px" src="<?=url('/images/Women\'s top 1.png');?>" alt="">
                    </div>

                    <div class="item" id="Red">
                    <img  style="height:560px" src="<?=url('/images/Women\'s top 2.png');?>" alt="">
                    </div>
                    <div class="item" id="Blue">
                    <img  style="height:560px" src="<?=url('/images/Women\'s top 3.png');?>" alt="">
                    </div>
