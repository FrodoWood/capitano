            ...
            <div class="row">
                ...
                <script>
                    ...
                    <ul class="image_list" style="list-style:none;">
                        <li style="margin-top:50px;" data-image="<?=url('/images/men\'s joggers 1.png');?>"><img height="150" onClick="changepic(this);" src="<?=url('/images/men\'s joggers 1.png');?>" alt=""></li>
                        <li style="margin-top:50px;" data-image="<?=url('/images/men\'s joggers 2.png');?>"><img height="150" onClick="changepic(this);"  src="<?=url('/images/men\'s joggers 2.png');?>" alt=""></li>
                        <li style="margin-top:50px;" data-image="<?=url('/images/men\'s joggers 3.png');?>"><img height="150" onClick="changepic(this);" src="<?=url('/images/men\'s joggers 3.png');?>" alt=""></li>
                    </ul>
                </div>
                ...
                <div class="carousel-inner" style="height:560px">
                    ...
                    <img  style="height:560px" src="<?=url('/images/men\'s joggers 1.png');?>" alt="">
                    </div>

                    <div class="item" id="Red">
                    <img  style="height:560px" src="<?=url('/images/men\'s joggers 2.png');?>" alt="">
                    </div>

                    <div class="item" id="Blue">
                    <img  style="height:560px" src="<?=url('/images/men\'s joggers 3.png');?>" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-5 order-3 text-center">
                    <div class="product_description ">
                       ...
                       Men's Joggers
                        ...
                        <div> <span class="product_price">£15</span> </div>
