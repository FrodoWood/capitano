...
<div class="container">
  <div class="row">
    <div class="col-8" style="background:aliceblue; padding:30px;margin-left:17%;padding-bottom:0px;">
  ...
  <div class="mb-5 " style="float:left; margin-left:50px;">
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div class="form-group" style="margin-top:130px;"> @if (Route::has('password.request')) <a class="btn btn-link" href="{{ route('password.request') }}"> {{ __('Forgot Your Password?') }} </a> @endif
        Not a member? <a data-toggle="tab" href="#signup">Sign Up</a> </div>
    </form>
  </div>
</div>
</div>
