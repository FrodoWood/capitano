...
<div class="container-fluid w-75 px-0">
    ...
    <div class="card-deck card-container justify-content-between">
                ...
                @if($loop->index >= 4)
                    @break
                @else
                <div class="card product-card my-4 rounded-0 border-0">
                    ...
                    <div class="card-body p-0 pt-3">
                        <h5 class="card-title text-center">{{$womenProduct-> title}}</h5>
...
<div class="row">
    <div class="col-6 order-first">
        <a href="{{url('/women')}}"><img class="img w-100 carousel-banner-img" src="{{URL('images/productWomen.jpg')}}" alt="Women" ></a>
    </div>
    <div class="col-6">
