...
<div class="container mt-4">
  ...
  <div class="container form-control-lg  mt-4">
    <h1 class = "h1- responsive text-center mx-auto page-title">Get In Touch</h1>
    ...
    <form action="/action_page.php">
      ...
      <div class="mb-4">
        ...
        <input type="text" class="form-control rounded-0" id="name" placeholder="Enter name" name="name" required>
      </div>
      <div class="mb-4">
        <label for="email">Email:</label>
        <input type="email" class="form-control rounded-0" id="email" placeholder="Enter email" name="email" required>
      </div>
      <div class = "mb-4">
        <label for= "number">Phone number</label>
        <input type="phone number" class="form-control rounded-0" id="number" placeholder="Enter phone number" name="number" required>
      </div>
      <div class="mb-4">
        <label for ="text area">Comments:</label>
        <textarea class ="form-control rounded-0" id="text area" rows= "3"placeholder="Please enter reason for contacting us" required></textarea>
      </div>
      <div class ="mb-4">
        <label>How would you like us to contact you?</label>
        <select name ="contact" class ="form-control rounded-0" id="dropdown" required>
